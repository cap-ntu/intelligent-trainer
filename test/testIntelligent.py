...
from conf.configSet_Pendulum_Intel_REINFORCE import CONFIG_SET_PENDULUM_INTEL_REINFORCE, \
    MODEL_NET_WORK_CONFIG_DICT_PENDULUM_INTEL_REINFORCE
from conf.configSet_MountainCarContinuous_Intel_REINFORCE import \
...
from conf.configSet_Reacher_Intel_REINFORCE import CONFIG_SET_REACHER_INTEL_REINFORCE, \
    MODEL_NET_WORK_CONFIG_DICT_REACHER_INTEL_REINFORCE
...
from conf.configSet_Swimmer_Intel_REINFORCE import CONFIG_SET_SWIMMER_INTEL_REINFORCE, \
    MODEL_NET_WORK_CONFIG_DICT_SWIMMER_INTEL_REINFORCE
...
# FIX, and RANDOM can use other config

env_config_dict = {
    "Pendulum-v0": {
        'RANDOM': (CONFIG_SET_PENDULUM_INTEL_REINFORCE, MODEL_NET_WORK_CONFIG_DICT_PENDULUM_INTEL_REINFORCE),
        'DQN': (CONFIG_SET_PENDULUM_INTEL, MODEL_NET_WORK_CONFIG_DICT_PENDULUM_INTEL),
        'REINFORCE': (CONFIG_SET_PENDULUM_INTEL, MODEL_NET_WORK_CONFIG_DICT_PENDULUM_INTEL),
        'FIX': (CONFIG_SET_PENDULUM_INTEL, MODEL_NET_WORK_CONFIG_DICT_PENDULUM_INTEL),
    },
    "MountainCarContinuous-v0": {
        'RANDOM': (CONFIG_SET_MOUNTAIN_CAR_CONTINUOUS_CONFIG_INTEL_REINFORCE,
                   MODEL_NET_WORK_CONFIG_DICT_MOUNTAIN_CAR_CONTINUOUS_INTEL_REINFORCE),
        'DQN': (
    ...
    "Reacher-v1": {
        'RANDOM': (CONFIG_SET_REACHER_INTEL_REINFORCE, MODEL_NET_WORK_CONFIG_DICT_REACHER_INTEL_REINFORCE),
        'DQN': (CONFIG_SET_REACHER_INTEL, MODEL_NET_WORK_CONFIG_DICT_REACHER_INTEL),
        'REINFORCE': (CONFIG_SET_REACHER_INTEL, MODEL_NET_WORK_CONFIG_DICT_REACHER_INTEL),
        'FIX': (CONFIG_SET_REACHER_INTEL, MODEL_NET_WORK_CONFIG_DICT_REACHER_INTEL),
    },
    "HalfCheetah": {
        'RANDOM': (CONFIG_SET_HALFCHEETAH_INTEL_REINFORCE, MODEL_NET_WORK_CONFIG_DICT_HALFCHEETAH_INTEL_REINFORCE),
        'DQN': (CONFIG_SET_HALFCHEETAH_INTEL, MODEL_NET_WORK_CONFIG_DICT_HALFCHEETAH_INTEL),
        'REINFORCE': (CONFIG_SET_HALFCHEETAH_INTEL, MODEL_NET_WORK_CONFIG_DICT_HALFCHEETAH_INTEL),
        'FIX': (CONFIG_SET_HALFCHEETAH_INTEL, MODEL_NET_WORK_CONFIG_DICT_HALFCHEETAH_INTEL),
    },
    "Swimmer-v1": {
        'RANDOM': (CONFIG_SET_SWIMMER_INTEL_REINFORCE, MODEL_NET_WORK_CONFIG_DICT_SWIMMER_INTEL_REINFORCE),
        'DQN': (CONFIG_SET_SWIMMER_INTEL, MODEL_NET_WORK_CONFIG_DICT_SWIMMER_INTEL),
        'REINFORCE': (CONFIG_SET_SWIMMER_INTEL, MODEL_NET_WORK_CONFIG_DICT_SWIMMER_INTEL),
        'FIX': (CONFIG_SET_SWIMMER_INTEL, MODEL_NET_WORK_CONFIG_DICT_SWIMMER_INTEL),
    },
}
...
parser.add_argument('--type', type=str, choices=['RANDOM', 'DQN', 'REINFORCE', 'FIX'])
...
if __name__ == '__main__':
    ...
    run_multiple_experiments(game_env_name=args.env,
                             ...
                             config_set_path=env_config_dict[args.env][args.type][0],
                             model_config_dict=env_config_dict[args.env][args.type][1],
                             num=args.num,
                             target_model_type=model_type_dict[args.env],
                             intelligent_trainer_model_type=args.type,
